...
export default async function TrackCalibratorPage({ searchParams }: { searchParams?: Promise<{ raceId?: string }> }) {
  ...
  return <section className="route-page"><TrackCalibratorClient raceId={raceId} initialProfile={JSON.parse(version.profileJson)} initialBackgroundAssetRef={version.backgroundAssetRef} /></section>;
}
